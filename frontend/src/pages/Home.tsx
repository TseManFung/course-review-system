  ...
  const onSubmitRegister = async (data: RegisterForm) => {
    ...
    try {
      if (!PASSWORD_REGEX.test(data.password)) {
        setError(
          "Password must include upper/lower case and special char, and be at least 8 characters"
        );
        return;
      }
      await registerUser(data);
      alert("Registered. Please verify email before logging in.");
        ...
        <Box component="form" onSubmit={loginForm.handleSubmit(onSubmitLogin)}>
          <Stack spacing={2}>
            <TextField
              label="User ID"
              fullWidth
              {...loginForm.register("userId", { required: "Required" })}
            ...
            <TextField
              ...
              {...registerForm.register("password", {
                ...
                pattern: {
                  ...
                  message:
                    "Must include upper/lower case, special char, at least 8 chars",
                },
              })}
